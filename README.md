...
* Enter this repository and version as  `https://github.com/onedevapp/Unity_SmartCredential.git#TAG` (see latest version [here](https://github.com/onedevapp/Unity_SmartCredentials/tags))
